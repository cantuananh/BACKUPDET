		...
		<div id="list-cart">
			...
			<form>
				<table class="table table-bordered .table-responsive text-center">
					...
					<tr>
						<td><img class="img-responsive" src="{{ asset('./img/'.$item->options->img) }}"></td>
						<td>{{ $item->name }}</td>
						<td>
						...
						<td><a class="btn btn-danger" href="{{asset('cart/delete/'.$item->rowId)}}">Xóa</a></td>
					</tr>
					@endforeach
				</table>
				<div class="row" id="total-price">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						<a href="{{ asset('/') }}" class="my-btn btn">Tiếp tục mua hàng</a>
